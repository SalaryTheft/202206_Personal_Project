...
본 약관은 Privacy(이하 “사이트”라 합니다)이 운영하는 웹사이트에서 제공하는 온라인 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
제 2 조 (용어의 정의)
...
라. 기타 회사가 정한 이용신청 요건이 미비한 경우.</pre>
            ...
            <div class="wide-card-area">
                <div class="wide-card">
                    <pre>본 사이트('privacy.com'이하 '사이트')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.

○ 이 개인정보처리방침은 2022년 1월 1부터 적용됩니다.

제1조(개인정보의 처리 목적)

본 사이트('privacy.com'이하 '사이트')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
...
제4조(개인정보의 파기절차 및 파기방법)
            ...
            <div class="wide-card-area">
                <div class="wide-card">
                    <form action="./action/mem_insert.jsp" method="post" id="register_form">
                        <label>아이디<br>
                            <input type="text" name="memId" placeholder="4글자 이상 입력" required>
                        </label><button id="check_id_btn">중복확인</button><br>
                        <label>비밀번호<br>
                            <input type="password" name="memPw" placeholder="4글자 이상 입력" required>
                        </label><br>
                        <label>비밀번호 확인<br>
                            <input type="password" name="memPwConfirm" placeholder="입력하신 비밀번호 확인" required><br>
                        </label>
                        <label>보안 질문<br>
